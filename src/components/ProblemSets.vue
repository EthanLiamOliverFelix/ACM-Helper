...
button, input { font: inherit; }.panel-header { display: flex; align-items: center; justify-content: space-between; gap: 7px; padding: 10px; border-bottom: 1px solid var(--color-bg-subtle); div { display: flex; flex-direction: column; min-width: 0; } strong { overflow: hidden; color: var(--color-text-strong); font-size: 13px; text-overflow: ellipsis; white-space: nowrap; } span { color: var(--color-text-faint); font-size: 9px; } button { padding: 4px 7px; border: 1px solid var(--color-border-control); border-radius: 4px; background: var(--color-bg-control-alt); color: var(--color-text-soft); font-size: 9px; cursor: pointer; &:disabled { opacity: .4; } } }
...
.home-entry-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 6px; margin: 0 10px 7px; }.home-entry { display: grid; min-width: 0; grid-template-columns: 20px 1fr auto; align-items: center; gap: 5px; padding: 9px 8px; border: 1px solid var(--color-success-border); border-radius: 6px; background: var(--color-success-surface); color: var(--color-tone-cdebdc); text-align: left; cursor: pointer; > span { color: var(--color-success-bright); font-size: 15px; } > div { display: flex; min-width: 0; flex-direction: column; gap: 2px; } strong, small { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; } strong { font-size: 10px; } small { color: var(--color-tone-7fa895); font-size: 7px; } b { color: var(--color-success-bright); font-size: 15px; } &:hover { filter: brightness(1.12); } }.plaza-entry { border-color: var(--color-accent-border); background: var(--color-accent-surface); color: var(--color-tone-d7efff); > span, b { color: var(--color-accent-text); } small { color: var(--color-tone-82a9c2); } }.contest-entry { border-color: var(--color-tone-536747); background: var(--color-tone-283527); color: var(--color-tone-d9edcf); > span, b { color: var(--color-tone-b5d6a7); } small { color: var(--color-tone-8ca781); } }.favorite-entry { border-color: var(--color-tone-77672f); background: var(--color-tone-37311f); color: var(--color-tone-eee1ae); > span, b { color: var(--color-warning); } small { color: var(--color-tone-aa9d6d); } }.bulk-bar { display: flex; align-items: center; gap: 7px; padding: 6px 10px; border-block: 1px solid var(--color-tone-3a3a3a); background: var(--color-bg-panel); font-size: 9px; span { flex: 1; color: var(--color-tone-888); } button { padding: 3px 6px; border: 1px solid var(--color-border-control); border-radius: 3px; background: var(--color-bg-subtle); color: var(--color-text-soft); cursor: pointer; &.danger { border-color: var(--color-tone-6a3939); color: var(--color-danger); } &:disabled { opacity: .4; } } }
